    ...
    try {
      ...
      if (currentUser != null) {
        ...
        if (snapshot.exists) {
          ...
          pickedProfileImage = data['store_image'];
        }
      }
    } catch (e) {
    ...
    try {
      ...
      if (imageFile != null) {
        ...
        fbs.Reference ref = fbs.FirebaseStorage.instance.ref(
          'ownerProfiles/${currentUser!.uid}/${path.basename(imageFile!.path)}',
        );
      ...
      CollectionReference foodStore =
      FirebaseFirestore.instance.collection('foodStores');

      await foodStore.doc(currentUser!.uid).update({
        'name': nameController!.text,
        'email': emailController!.text,
        'phone': phoneController!.text,
        'location': locationController!.text,
        if (pickedProfileImage != null) 'store_image': pickedProfileImage,
      });
